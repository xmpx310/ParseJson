...
if(!$_GET['date'] && !$_GET['run']){
    $dirList = scandir($dir);
    echo '<html><head><base target="detail" />
       <script src="/xhprof_html/jquery/jquery-1.2.6.js"></script>
    <script src="/xhprof_html/js/showDetail.js"></script>
    </head><body>';
...
echo "<script src='/xhprof_html/js/showInfo.js'></script>";
echo "</head>";
...
$dir = $dir. DIRECTORY_SEPARATOR. $_GET['date'];
